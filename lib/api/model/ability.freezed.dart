...
abstract class $AbilityCopyWith<$Res> {
  ...
  @useResult
  $Res call({@JsonKey(name: 'ability') AbilityDetails ability});
...
class _$_Ability implements _Ability {
  _$_Ability({@JsonKey(name: 'ability') required this.ability});
...
abstract class _Ability implements Ability {
  factory _Ability(
          {@JsonKey(name: 'ability') required final AbilityDetails ability}) =
      _$_Ability;
